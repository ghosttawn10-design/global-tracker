...
export const CreateShipmentBody = zod.object({
  ...
  "currentLng": zod.number().optional(),
  "routePoints": zod.string().optional(),
  "progressPercent": zod.number().default(createShipmentBodyProgressPercentDefault)
})
...
export const GetShipmentsByMonthResponse = zod.array(GetShipmentsByMonthResponseItem)
