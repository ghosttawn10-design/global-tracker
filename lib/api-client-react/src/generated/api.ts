...
export const listShipments = async (params?: ListShipmentsParams, options?: RequestInit): Promise<ShipmentsListResponse> => {
...
export const createShipment = async (createShipmentBody: CreateShipmentBody, options?: RequestInit): Promise<Shipment> => {
...
export const getCreateShipmentMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createShipment>>, TError,{data: BodyType<CreateShipmentBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createShipment>>, TError,{data: BodyType<CreateShipmentBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createShipment>>, {data: BodyType<CreateShipmentBody>}> = (props) => {
          const {data} = props ?? {};
...
export const updateShipment = async (id: number,
    updateShipmentBody: UpdateShipmentBody, options?: RequestInit): Promise<Shipment> => {
...
export const getUpdateShipmentMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateShipment>>, TError,{id: number;data: BodyType<UpdateShipmentBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateShipment>>, TError,{id: number;data: BodyType<UpdateShipmentBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateShipment>>, {id: number;data: BodyType<UpdateShipmentBody>}> = (props) => {
          const {id,data} = props ?? {};
...
export const getGetShipmentsByStatusQueryKey = () => {
    return [
    `/api/analytics/shipments-by-status`
    ] as const;
    }
...
export const getShipmentsByMonth = async ( options?: RequestInit): Promise<MonthlyData[]> => {
...
export const getGetShipmentsByMonthQueryKey = () => {
    return [
    `/api/analytics/shipments-by-month`
    ] as const;
    }


export const getGetShipmentsByMonthQueryOptions = <TData = Awaited<ReturnType<typeof getShipmentsByMonth>>, TError = ErrorType<unknown>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getShipmentsByMonth>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetShipmentsByMonthQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getShipmentsByMonth>>> = ({ signal }) => getShipmentsByMonth({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getShipmentsByMonth>>, TError, TData> & { queryKey: QueryKey }
}

export type GetShipmentsByMonthQueryResult = NonNullable<Awaited<ReturnType<typeof getShipmentsByMonth>>>
...
export function useGetShipmentsByMonth<TData = Awaited<ReturnType<typeof getShipmentsByMonth>>, TError = ErrorType<unknown>>(
  options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getShipmentsByMonth>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
...
export const listContacts = async (params?: ListContactsParams, options?: RequestInit): Promise<ContactMessage[]> => {
...
export const submitContact = async (createContactBody: CreateContactBody, options?: RequestInit): Promise<ContactMessage> => {
...
export const getSubmitContactMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof submitContact>>, TError,{data: BodyType<CreateContactBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof submitContact>>, TError,{data: BodyType<CreateContactBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof submitContact>>, {data: BodyType<CreateContactBody>}> = (props) => {
          const {data} = props ?? {};
...
export const markContactRead = async (id: number, options?: RequestInit): Promise<ContactMessage> => {
...
export const updateTestimonial = async (id: number,
    createTestimonialBody: CreateTestimonialBody, options?: RequestInit): Promise<Testimonial> => {
...
export const getUpdateTestimonialMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateTestimonial>>, TError,{id: number;data: BodyType<CreateTestimonialBody>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateTestimonial>>, TError,{id: number;data: BodyType<CreateTestimonialBody>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateTestimonial>>, {id: number;data: BodyType<CreateTestimonialBody>}> = (props) => {
          const {id,data} = props ?? {};
...
/**
 * @summary Upload a small file to Neon
 */
